...
{
    /**
     * Error information regarding the account creation.
     *
     * This is only present if the account creation failed.
     *
     * @var ErrorResponse
    ...
    /**
     * Success information regarding the account creation.
     *
     * This is only present if the account creation was successful.
     *
     * @var SuccessResponse
