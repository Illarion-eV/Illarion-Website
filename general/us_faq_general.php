...
<ul>
   ...
   <li><a class="hidden" href="#15">How do I find out an item's stats?</a></li>
...
<ul>
	...
	<li class="answer">
	 Operating system: Windows XP/Vista/7, Linux, MacOS <br>
    Graphics card: 16MB memory, driver with OpenGL support<br>
    CPU: 500 MHz and better<br>
	...
	<li class="answer">Once you have <a href="http://illarion.org/community/account/us_charlist.php" >created your character</a> you need to log onto the client with the relevant character's name that you want to play (Names are case sensitive) and your account password</li>
</ul>
...
<ul>
	...
	<li class="answer">Paperdolling isn't yet featured in Illarion (implemented into the next update). To know what someone else looks like, you can click on the character to get a short description and what items he has equipped. Right-clicking will show you an option to view him carefully. This sends a message to the player, so don't do it frequently, but allows you to view most of the items they are wearing.</li>
	
	<li class="question"><a name="11">Does the game have storage facilities?</a></li>
	<li class="answer">Yes. The game uses a "depot" system. These are yellow storage boxes scattered around key areas such as towns. To use them, move next to them and "open" them as you would a bag, you can then drag and drop any items you wish to store into the depot.</li>
</ul>
...
<ul>
	...
	<li class="answer">Role playing games (RPG) are a popular game genre. Players take on the role of a fantasy character and are able to do many things that may be impossible in Real Life. Illarion takes the concept of Role playing further than other games, players are expected to immerse themselves completely into the life of their character. Whilst playing Illarion you cease to be John/Jane Smith from New York and instead take on the role of a fictional character by feeling, saying, and thinking what he or she would. Illarion is set in a medieval world with no electricity, cars, televisions or power tools. Whilst playing you are expected to refrain from mentioning anything Out Of Character (OOC). If this concept does not interest you, then Illarion is probably not the game for you.</li>
	
	<li class="question"><a name="13">What are CMs and GMs?</a></li>
	<li class="answer">A CM is a Community Manager. Their role is to assist new players and help resolve issues or conflicts between players. They should be the first people to turn to in the event of a non-technical issue. A GM is a Game Master. The GMs mainly provide dynamic content (quests, events, etc). They also uphold the rules of Illarion and may punish players for breaking the rules or exploiting bugs.</li>
	...
	<li class="question"><a name="15">How do I find out an item's stats?</a></li>
