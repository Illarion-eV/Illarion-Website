...
<ul>
	...
	<li class="question"><a name="4">Why isn't the game starting?</a></li>
		If the game is installed and launched correctly but fails to start please check the <a href="http://illarion.org/community/forums/viewforum.php?f=3&sid=242eca57695d6d0ac04e9160ef8cf46b" >Support Forums</a> for any known issues
...
<ul>
	...
	<li class="question"><a name="10">I equipped an item so why doesn't it show on my character?</a></li>
		Paperdolling isn't yet featured in Illarion (implemented into the next update). To know what someone else looks like, you can click on the character to get a short description and what items he has equipped. Right-clicking will show you an option to view him carefully. This sends a message to the player, so don't do it frequently, but allows you to view most of the items they are wearing.
...
<ul>
	...
	<li class="question"><a name="13">What are CMs and GMs?</a></li>
		A CM is a Community Manager. Their role is to assist new players and help resolve issues or conflicts between players. They should be the first people to turn to in the event of a non-technical issue. A GM is a Game Master. The GMs mainly provide dynamic content (quests, events, etc). They also uphold the rules of Illarion and may punish players for breaking the rules or exploiting bugs.
