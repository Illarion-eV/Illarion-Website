<?php
    class HighScore {
        ...
        function print_on_site($lang) {
            ...
            .PHP_EOL.'LEFT JOIN homepage.character_details'
...
<table style="width:100%">
	...
	<tbody>
		...
		<tr class="row<?php echo ($i % 2); ?>">
			...
			<td style="text-align:center;"><?php echo $this->getFactionImageHtml($factionTotal[$i]["faction"]); ?></td>
			...
			<td style="text-align:right;"><?php echo ($i + 1); ?>.</td>
			<td style="text-align:center;"><?php echo $this->getFactionImageHtml($factionMonthly[$i]["faction"]); ?></td>
...
<?php
    ...
    function get_highscores() {
        ...
        $highscores[] = new HighScore(['us' => 'King of the Shovel', 'de' => 'Buddlerk&ouml;nig'],
                                      "SELECT qpg_userid AS id, qpg_progress AS points FROM illarionserver.questprogress WHERE qpg_questid = 60",
