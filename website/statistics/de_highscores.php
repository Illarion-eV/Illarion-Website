...
<?php
    ...
    if (!is_null($list)) {
        ...
        echo '<tr><th></th><th>Fraktion</th><th>Charakter</th><th><img src="' . Page::getCurrentImageURL() . '/items/61.png" alt="Gold" title="Goldm&uuml;nzen"/></th></tr>';
	    ...
	    foreach($list as $key=>$char) {
			...
			{
				echo '<a class="rating8" href="'.Page::getURL().'/community/de_charprofile.php?id='.dechex( $char['id'] ).'">'.$char['name'] . '</a>';
			}
			else
			{
				echo $char['name'];
...
<?php
	...
	if (!is_null($list)) {
        ...
        echo '<tr><th></th><th>Fraktion</th><th>Charakter</th><th><img src="' . Page::getCurrentImageURL() . '/items/1.png" alt="Schwert" title="Arenapunkte"/></th></tr>';
