<?php
    ...
    function processSave()
    {
    	...
    	if ( $chardata['chr_status'] == 40 )
    	{
    		...
    		{
    		    Messages::add((Page::isGerman() ? 'Die gew‰hlte Kˆrpergrˆﬂe ist auﬂerhalb der Zul‰ssigen Grenzen.' : 'The chosen body height is out of Range').' '.$limits['minbodyheight'].'&lt;'.$new_bodyheight.'&lt;'.$limits['maxbodyheight'], 'error');
    		    return;
    		}
