...
<h2><a href="http://illarion.org/mantis/view.php?id=9659" target="_blank">Meilenstein I: Stabiler Zustand für Reviewer und Werbung</a></h2>

<p>Dieser Meilenstein zielt darauf ab, das Spiel von Fehlern zu befreien und den Eindruck während der ersten Spielstunde und den Weg dorthin zu verbessern. Der gesamte Weg vom Auffinden des Spiels, seiner Installation und dem Start ins Spiel ist enthalten. Inhalte, die sich nicht in der ersten Spielstunde bemerkbar machen, sind nicht Inhalt des Meilensteins, seien sie noch so wichtig für das Spiel.</p>
...
<p>Mit diesem Meilenstein werden dem Spiel eine sinnvolle Anzahl von Gegenständen hinzugefügt, insbesondere Waffen und Rüstungen. Ihr Nutzen und ihre Herstellung werden in Hinblick auf die Handwerke, deren Verteilung über die Städte, Ressourcen, Verbrauchsmaterialien und Preise gestaltet.</p>
...
<p>Magie ist ein notwendiges Features eines Fantasyspiels. Mit diesem Meilenstein werden wir die arkane Magie wieder einführen und ebenso die heilige Magie der Götter. Entsprechende Anpassungen an handwerksähnliche Systeme wie Alchemie werden erfolgen.</p>
...
<p>Das derzeitige Kampfsystem bedarf einer Überarbeitung, um fairer, klarer und verlässlicher zu werden. Dieser Meilenstein wird für die Spieler nur wenige sichtbare Veränderungen bringen, jedoch zu einem deutlich verbesserten und flexibleren Kampfsystem führen.</p>
