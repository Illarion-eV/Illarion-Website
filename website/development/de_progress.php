...
<p>Wenn du bei der Entwicklung Illarions mithelfen willst, wende dich an einen der <a href="<?php echo Page::getURL(); ?>/community/de_contact.php#4">Entwickler</a> oder schau einfach mal im <a href="<?php echo Page::getURL(); ?>/community/de_chat.php">Chat</a> vorbei. Klicke auf Titel der Arbeitspakete, um auf die entsprechende Zusammenstellung der Entwicklungspunkte im Mantis-Bugtracker zu gelangen.</p>

<h2><a href="<?php echo Page::getURL(); ?>/mantis/view.php?id=9659" target="_blank">Stabiler Zustand für Reviewer und Werbung</a></h2>
...
<h2><a href="<?php echo Page::getURL(); ?>/mantis/view.php?id=9822" target="_blank">Neue Gegenstände und verbessertes Handwerk</a></h2>
...
<h2><a href="<?php echo Page::getURL(); ?>/mantis/view.php?id=9823" target="_blank">Magie</a></h2>
...
<h2><a href="<?php echo Page::getURL(); ?>/mantis/view.php?id=9914" target="_blank">Überarbeitung des Kampfsystems</a></h2>
...
<h2><a href="<?php echo Page::getURL(); ?>/mantis/view.php?id=9825" target="_blank">Sandkasten und Immersion</a></h2>
...
<h2><a href="<?php echo Page::getURL(); ?>/mantis/view.php?id=9824" target="_blank">Inhalte, Quests und Dungeons</a></h2>
