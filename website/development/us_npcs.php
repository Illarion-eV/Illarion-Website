...
<p>
You all know the easyNPC-editor written by Nitram. When using the editor there is an option to "upload" the script which simply copies the script you're working on to the server (implying that you need internet connection of course). The NPC, once you have uploaded the script, stands on the testserver awaiting testing. We provide you with the testserver client and an account with 2 characters on the testserver to access it directly so that you can test your own NPC immediately.
</p>
<p>
