...
?>
<h1>Character Details - <?php echo $char_data['chr_name']; ?></h1>
	...
	<form action="<?php echo Page::getURL(); ?>/illarion/gmtool/de_character_style.php?charid=<?php echo $charid; ?>&amp;server=<?php echo $_GET['server']; ?>" method="post">
            ...
            <table style="width:100%;">
                <tbody>
                    <tr>
                        <td>
                            Weight: <?php echo $slider_info['limit_text']['weight']; ?>
                        </td>
                    ...
                    <tr>
                        <td>
                            Height: <?php echo $slider_info['limit_text']['height']; ?>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            Age: <?php echo $slider_info['limits']['minage']; ?> Jahre bis <?php echo $slider_info['limits']['maxage']; ?> Years
                        </td>
                        <td>
