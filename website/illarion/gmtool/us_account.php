<?php
    ...
    Page::setDescription( 'Here is an overview of the users account settings' );
		...
		<dl class="gmtool">
			...
			<dd>
				<select name="timezone">
					...
					<option value="-9.5"<?php if ($account_data['acc_timeoffset'] == -9.5) { echo ' selected="selected"'; } ?>>(UTC -09:30) Taiohae, Marquesas Islands</option>
					<option value="-9"<?php if ($account_data['acc_timeoffset'] == -9) { echo ' selected="selected"'; } ?>>(UTC -09:00) Alaska</option>
					<option value="-8"<?php if ($account_data['acc_timeoffset'] == -8) { echo ' selected="selected"'; } ?>>(UTC -08:00) Pacific Time (US &amp; Canada)</option>
					...
					<option value="-1"<?php if ($account_data['acc_timeoffset'] == -1) { echo ' selected="selected"'; } ?>>(UTC -01:00) Azores, Cape Verde Islands</option>
					<option value="0"<?php if ($account_data['acc_timeoffset'] == 0) { echo ' selected="selected"'; } ?>>(UTC 00:00) Western European Time, London, Lisbon, Casablanca</option>
					...
					<option value="8.75"<?php if ($account_data['acc_timeoffset'] == 8.75) { echo ' selected="selected"'; } ?>>(UTC +08:45) Western Australia</option>
					...
					<option value="10"<?php if ($account_data['acc_timeoffset'] == 10) { echo ' selected="selected"'; } ?>>(UTC +10:00) Eastern Australia, Guam, Vladivostok</option>
					...
					<option value="12.75"<?php if ($account_data['acc_timeoffset'] == 12.75) { echo ' selected="selected"'; } ?>>(UTC +12:45) Chatham Island</option>
