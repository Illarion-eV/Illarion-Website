<?php
    ...
    Page::setTitle( array( 'GM-Tool', 'Characterlist' ) );
    Page::setDescription( 'A overview about all characters that were created in the account.' );
    Page::setKeywords( array( 'GM-Tool', 'Account', 'Characters', 'Overview') );
...
<table style="width:100%;">
	...
	<tbody>
        ...
        { ?>
            <tr><td style='height:50px;text-align:center;' colspan='6'>No characters were found.</td></tr>
	    <?php } else { ?>
