...
<div>
	<h1>
		<img src="<?php echo $url; ?>/illarion/calendar/images/image_4.gif" style="height:60px;width:60px;" alt="Bär" />
		Der beständige Bär
	</h1>
	...
	<p>ausgeglichen, ruhig, weise</p>

	<br />
	<b>Negative Eigenschaften</b>
	<p>oftmals sehr eigenwillig</p>
</div>
