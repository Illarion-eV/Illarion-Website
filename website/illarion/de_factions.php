...
<a href="<?php echo Page::getURL(); ?>/general/de_map_of_illarion.jpg"><img align="centre" width="400" height="331" src="<?php echo $url; ?>/general/de_bigthumb_map_of_illarion.jpg" alt="Karte von Illarion"/></a>
