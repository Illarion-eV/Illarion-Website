<?php
	...
	"Das Zeitalter des Kampfes",
	"Hintergrund, Götter, Geschichte");
	include_header();
?>

<?php navBarTop("de_age_2.php","de_overview.php","de_age_4.php"); ?>
