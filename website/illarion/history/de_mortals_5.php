<?php
	...
	"Der Fall des Hauses Narníl",
	"Hintergrund, Götter, Geschichte");
	include_header();
?>

<?php navBarTop("de_mortals_4.php","de_overview.php","de_mortals_6.php"); ?>
