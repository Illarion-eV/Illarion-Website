<?php
	...
	"Feuer und die Rache der Elfen",
	"Hintergrund, Götter, Geschichte");
	include_header();
?>

<?php navBarTop("de_mortals_2.php","de_overview.php","de_mortals_4.php"); ?>
...
<p>Wütend über ihre Verluste sammelten sich die Orks entlang des Waldrandes und entzündeten große Scheiterhaufen. Als es Nacht wurde, setzten die Orks den Waldrand großflächig in Brand. Es dauerte mehrere Wochen, bis das Feuer, welches sich rasch ausgebreitet hatte, vollends erloschen war. Eine riesige Waldfläche sowie drei Dörfer der Elfen fielen den Flammen zum Opfer. Die Orks legten sich am Waldrand auf die Lauer, um die Fliehenden gefangen zu nehmen. Nach orkischer Tradition wurden die am schwersten verwundeten Gefangenen den Göttern als Dank für den Sieg geopfert. Da die Orks nach Monaten der Wanderung schweren Hunger litten verspeisten sie die Übrigen bei der Siegesfeier.</p>

<p>Schon drei Tage später, mitten in den Siegesfeierlichkeiten, wurde das Lager der Clans angegriffen. In großer Zahl waren Elfen erschienen, gerüstet mit mächtigen Waffen und Rüstungen, die zum Teil noch aus alten Kriegen stammten und solchen, die nach alter Kunst hergestellt worden waren. Elfische Magie schlug Breschen in die orkischen Palisaden und während die Gefangenen flohen, sprangen Kriegstänzer und Schwertsänger mitten zwischen die verblüfften Orks. Schon nach kurzer Zeit wurde aus der Verblüffung der orkischen Krieger eine wilde Flucht: Einem Feind, der sich unnatürlich schnell bewegte, Blitz und Feuer werfen konnte und urplötzlich mitten in den eigenen Reihen auftauchte, war nichts entgegenzusetzen. Fast die Hälfte aller anwesenden Orks wurde innerhalb dieses einen Überraschungsangriffes getötet. Da auch die Elfen Verluste erlitten hatten, beschlossen sie, die Fliehenden nicht zu verfolgen, sondern auf Verstärkung zu warten und die Gefallenen zu ehren.</p>

<p>Der Älteste des Waraxe-Clan entschied, möglichst schnell aus dem Gebiet der Elfen zu verschwinden, da ein Krieg unnötig sei und die Stämme in ihrem durch Hunger und Kampf geschwächten Zustand gegen den Gegner nicht weiter bestehen könnten. Der Howling-Wolf-Clan schloss sich der Entscheidung an, während der Nighthawk-Clan weiterkämpfen wollte. Letzterer wurde später vernichtend geschlagen. Der Bloody-Skull-Clan entschied sich, Unterhändler mit Geschenken zu den Elfen zu entsenden. Keiner der Unterhändler kam jedoch an. In den folgenden Jahrzehnten kam es immer wieder zu kleineren Scharmützeln zwischen Orks und Elfen. Die Orks waren durch jahrelange Wanderung derart geschwächt, dass sie keine allzu große Gefahr darstellten, dennoch hatten sie gelernt Bögen und Schwerter zu benutzen und herzustellen.</p>

<?php navBarBottom("de_mortals_2.php", "de_mortals_4.php"); ?>
