...
<p>So, you can use the ticket, travel to <a href="http://illarion.org/illarion/us_world.php" class="eyecatcher">Illarion</a>, seek adventure, and <a href="http://illarion.org/community/account/us_register.php" class="eyecatcher">start a new life</a>, or just leave it be - the choice, dear nephew, is entirely yours.</p>
