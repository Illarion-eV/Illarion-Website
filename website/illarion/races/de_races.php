...
<p>You will find <a href="http://illarion.org/illarion/us_world.php" class="eyecatcher">Illarion</a> vastly different to the lands of Albar, Salkamar and Gynk that you are familiar with. Three realms, <a href="http://illarion.org/illarion/us_factions.php#1" class="eyecatcher">Cadomyr</a>, <a href="http://illarion.org/illarion/us_factions.php#2" class="eyecatcher">Galmair</a> and <a href="http://illarion.org/illarion/us_factions.php#3" class="eyecatcher">Runewick</a> dominate the land but not only <a href="de_humans.php" class="eyecatcher">humans</a> like you and I live here. Stubborn <a href="de_dwarves.php" class="eyecatcher">dwarves</a> mine the Nameless Mountains and wise <a href="de_elves.php" class="eyecatcher">elves</a> inhabit the dense forests. In the southeast you will find a small and homely <a href="de_halflings.php" class="eyecatcher">halfling</a> settlement called Yewdale, whilst wild <a href="de_orcs.php" class="eyecatcher">orcs</a> roam the Kantabi Desert. Even some strange <a href="de_lizards.php" class="eyecatcher">lizards</a> folk who seem to hiss prayers all the time frequent these shores.</p>
...
<p>So, you can use the ticket, travel to <a href="http://illarion.org/illarion/de_world.php" class="eyecatcher">Illarion</a>, seek adventure, and <a href="http://illarion.org/community/account/de_register.php" class="eyecatcher">start a new life</a>, or just leave it be - the choice, dear nephew, is entirely yours.</p>
