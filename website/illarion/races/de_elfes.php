...
<div class="menu">
	<ul class="menu_top">
		...
		<li class="selected"><a href="<?php echo $url; ?>/illarion/races/de_elfes.php">Elfen</a></li>
...
<table class="center"><tr><td><img src="<?php echo $url; ?>/shared/pics/races/elf_m.png" alt="münnlicher Elf"/></td><td> </td><td><img src="<?php echo $url; ?>/shared/pics/races/elf_f.png" alt="weiblicher Elf"/></td></tr></table>
<?php cap(D); ?>
...
wirklich alt aussehenden Elfen zu Gesicht bekommen und sie scheinen bezüglich ihres Alters noch verschlossener zu sein,
als sie ohnehin schon sind. Es gibt aber Gerüchte von Elfen, die angeblich sechs oder sieben tausend Jahre alt sind. Wie
...
Städte und Ansiedlungen errichtet, welche häufig in unberührter Natur zu finden sind. Ihre Häuser sind in einer Art gebaut,
dass sie sich perfekt an die Umgebung anpassen. Es gibt Berichte, dass Reisende, welche sich im Wald verirrt hatten, sich direkt
vor den Toren einer Siedlung der Elfen befanden, ohne dass sie davon Kenntnis genommen hätten. Erst als sich die Elfen ihnen zu
erkennen gaben, konnten die Häuser versteckt zwischen den Bäumen erkannt werden. Diese Gerüchte begünstigen auch den Glauben
vieler Leute, dass Elfen über Magie verfügen, welche sie in die Lage versetzt, ihre Behausungen für Uneingeweihte unauffindbar
zu machen. Es gibt sogar Stimmen, die behaupten, dass Elfen die Bäume selbst dazu veranlassen können, in einer Form zu wachsen,
wodurch Räume, Treppen und Terrassen entstehen. Ob aber diese fantastisch klingenden Geschichten der Wahrheit entsprechen, vermag
ich nicht zu sagen. Übereinstimmend ist nur, dass alle Personen die eine Elfenstadt zu Gesicht bekommen haben, von der
unglaublichen Schönheit dieser Orte berichten. Dabei mag hervorgehoben werden, dass die Baukunst der Elfen sehr filigran,
ja fast verletzlich erscheint, so als ob sie nur Gast in ihren eigenen Behausungen wären. Jederzeit bereit, das Geschenk des
...
Die sprichwörtliche Geduld eines Elfen, kann für Vertreter anderer Völker mitunter eine große Herausforderung sein. Dies sollte
aber nicht zu der Annahme verleiten, dass Elfen wehrlos sind, auch wenn sie nur in höchster Not zur Waffe greifen. Sie sind
traditionell äußerst geschickt in der Handhabung von Bögen und im Gebrauch langer, einhändig geführter Schwerter. Aufgrund der
Wahl ihrer Waffen und der Besonderheit ihrer Kriegsführung, in welcher sie offene Kämpfe vermeiden, bevorzugen Elfen nur leichte
...
gefertigten Gegenstände auszeichnet. Dabei zeigen sie, vielleicht mit Ausnahme der Holzbearbeitung, kein ausgesprochenes Talent in
diesen Berufen, jedoch ist es ihnen vergönnt, sehr viel Zeit in die Perfektion einer Tätigkeit zu stecken. Somit mag der Ausspruch
eines menschlichen Ritters verziehen werden, der gesagt hat, dass wohl der Sohn seines Sohnes die teure und wunderschöne Waffe in der
Schlacht führen wird, welche er bei einem elfischen Schmiedemeister in Auftrag gegeben hatte.</p>
