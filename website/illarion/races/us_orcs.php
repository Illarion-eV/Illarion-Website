<?php
	...
	create_header( 'Illarion - Background - Orcs',
	'Races Illarions',
...
<p>Summertime often means wartime for an orc tribe. These wars are often territorial conflicts between the different orc tribes,
...
servants, mostly peasants, cooks, or forced to help the women with their work. If the slave is worthy and shows good work or strength, and
...
Orcs seem to love the sound of a drum, too. "Normal" songs, if played by a good bard, can fascinate an orc too, but it may
sound strange to him, like music from another culture always does.</p>
