<?php
   ...
   create_header( "Illarion - Hintergrund - Client",
                  "Tanora -G&ouml;ttin des Wassers.   ",
                  "Hintergrund, G&ouml;tter, Geschichte" );
   include_header();
?>

<?php navBarTop( "de_bck_13.php","de_bck_10.php","de_bck_15.php" ); ?>
...
<h2>Anhänger</h2>
<p>Tanora herrscht in der Echsengesellschaft vor. Viele ihrer Tempel befinden sich entlang der Küste oder sogar unter Wasser. Ein Beispiel hierfür ist ihr Tempe in der Schlangenkopfbucht. Wie alle anderen Alten Götter wird auch sie im Tempel der Fünf, im Osten Galmairs verehrt. Außerdem gibt es die Kapelle der Fünf im Osten der Kantabi Wüste, wo die Namen der Fünf in Ehren gehalten werden.Da der Glaube kein Heim außer dem eigenen Verstand und der Seele braucht, wird sie auch an vielen unscheinbaren Orten entlang der Küste Illarions verehrt, wie zum Beispiel dem Kap des Abschieds südlich von Cadomyr.</p>

<p>Die meisten Anhänger Tanoras sind Echsenmenschen, Seefahrer, oder sogar Elfen, obwohl auch viele Heiler zu ihr beten. Ihre Anhänger glauben, dass sie eine sehr mächtige, gerechte Göttin ist. Da viele ihrer Echsenpriester uralten Traditionen folgen, sind manche davon fanatische Gläubige, die böse Kreaturen vernichten, wo immer sie sie finden können. Andere Gefolgsleute sind von friedlicher Natur. Die Anhänger Tanoras glauben, dass die Welt und Magie einen gemeinsamen Fluss bilden und dass Leben aus der Berührung der Göttin entspringt. Nach ihrem Tod werden sie eine fast endlose See überqueren müssen. Wenn sie zu Lebzeiten gut waren, mag ihnen die Göttin vielleicht ein Boot schicken, das sie sicher zur Küste bringt. Die, die Unrecht getan haben, müssen schwimmen und dabei einen Steinhaufen über das Meer tragen. Für jede Sünde während ihres Lebens wird dabei ein weiterer Stein aufgelegt. Wenn der Steinhaufen zu schwer ist, müssen sie warten und auf die Gnade anderer hoffen, die ihnen mit ihrer Last helfen. Wenn sie ertrinken, schickt die Göttin sie als Tier zurück auf die Welt, welches den Leuten dient und dort müssen sie bleiben, bis ihre Schuld abgeleistet ist.</p>
   
<h2>Tanos - Monat der Fluten</h2>
...
<h2>Sternzeichen - Der verträumte Delphin</h2>

<img align="right" vspace="0" hspace="5" src="<?php echo $url; ?>/illarion/calendar/images/image_2.png" alt="Der verträumte Delphin"/>
...
<?php navBarBottom( "de_bck_13.php", "de_bck_15.php" ); ?>
