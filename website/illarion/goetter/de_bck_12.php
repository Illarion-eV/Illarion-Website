<?php
   ...
   create_header( "Illarion - Hintergrund - Client",
                  "Br&aacute;gon -Gott des Feuers.",
                  "Hintergrund, G&ouml;tter, Geschichte" );
   include_header();
?>

<?php navBarTop( "de_bck_11.php","de_bck_10.php","de_bck_13.php" ); ?>
...
<h2>Anhänger</h2>
<p>Brágon wird nachgesagt, dass er sich von all den Alten Göttern am wenigsten für Illarion interessiert. Manchmal jedoch, stattet er dennoch einen Besuch ab und hat bereits persönlich Tempel errichtet. Nur wenige Anhänger sind bekannt und einem Wesen mit so anspruchsvollem Geschmack eine halbherzige Opfergabe darzubringen, wird nur Zorn zur Folge haben. Er hat Malachin die Macht über viele seiner ehemaligen Gefolgsleute übertragen. Wie alle Alten Götter, wird auch er im Tempel der Fünf im Osten Galmairs verehrt. In der Kapelle der Fünf im Osten der Kantabi Wüste, betet Hohepriester Bathelor seinen Herrn in Brágons Allerheiligstem. Die Leute beten oft dafür, dass die brennende Sonne, die Brágon erschaffen hat, während ihren Wanderungen durch die Wüste gnädig zu ihnen sein möge.</p>
   
<h2>Brás - Monat der Opferung</h2>
...
<h2>Sternzeichen - Der edle Drache</h2>

<img align="right" vspace="0" hspace="5" src="<?php echo $url; ?>/illarion/calendar/images/image_7.png" alt="Der edle Drache"/>
...
<?php navBarBottom( "de_bck_11.php", "de_bck_13.php" ); ?>
