<?php
   ...
   create_header( "Illarion - Hintergrund - Client",
                  "Eldan - Gott desGeistes.",
                  "Hintergrund, G&ouml;tter, Geschichte" );
   include_header();
?>

<?php navBarTop( "de_bck_12.php","de_bck_10.php","de_bck_14.php" ); ?>

<h1>Eldan - Gott des Geistes</h1>

<?php cap(E); ?>
<p>Eldan ist der Gott des Elements Geist und wird als weisester von ihnen angesehen. Wegen seines nachdenklichen Gebahrens könnte man denken, dass er abgehoben ist und daraus schließen, dass sein Geist die Welt verlassen und er Zuflucht in der weltfremden Festung seiner eigenen Gedanken gesucht hat. Weisheit ist sein Erkennungszeichen und doch zieht er es vor still zu bleiben, wenn andere ihre Torheiten hinausschreien. Eldan mag als weiser Magier, Gelehrter, Bettler oder sogar betrunkener Philosoph erscheinen, doch er wird immer einen hölzernen Stab tragen. Er vermeidet größere Städte und Ansammlungen von Leuten und zieht friedvolle Abgeschiedenheit vor, sei es ein Ort des Lernens, oder eine entlegene Taverne.</p>

<h2>Anhänger</h2>
<p>Eldan war nie sehr aktiv in die Geschicke der Sterblichen verwickelt. Sehr wenige beten zu ihm, da er nur äußerst selten in der Öffentlichkeit gesehen wurde und nur ein paar Leute wissen, wie dieser Gott zu erkennen ist. Seine Anhänger sind geheimnistuerisch und es gibt seltsame Gerüchte, laut derer er in Verkleidung durch Illarion streift. Seine Gefolgsleute sind oft Eremiten oder solche, die ihren Wein gerne bei langen, philosophischen Gesprächen genießen.  Diese Anhänger behaupten, Eldan persönlich getroffen zu haben und statt zu beten, sprechen oder diskutieren sie an einsamen Orten - oder in Runewick. Er wird auch im Tempel der Fünf im Osten Galmairs und in der Kapelle der Fünf im Osten der Kantabi Wüste verehrt. Viele derer, die traditionell Eldans Pfaden gefolgt wären, beten nun zu Elara.</p>
   
<h2>Eldas - Monat des Fastens</h2>
...
<p>Die Halblinge aus Eibental feiern die letzte Woche des Eldas mit den sogenannten "Höhlentagen" und erinnern damit an den Widerstand während der Zeit des Niedergangs von Firnismühle. Traditionell ziehen sie sich für die Dauer der gesamten Woche in Wälder zurück und verbringen dort die Nächte in selbstgebauten Höhlen oder Gruben, sich ausschließlich von Früchten des Waldes ernährend, da jegliches Feuer verboten ist. Am Ende der Woche kehren sie in einer gerüsteten Prozession zurück und verursachen dabei großen Lärm, um die Wiedereinnahme der Gebiete zu symbolisieren, die einst von den Orks besetzt gewesen waren. Modernere Halblinge die in Städten leben, sowie die Oberschicht der Rasse, variieren diese Tradition, indem sie Zelte in ihren Gärten oder vielleicht einem Innenhof ihres Hauses aufstellen. Manchmal mag sogar ein Fleischgericht serviert werden, obwohl dieses dann mit viel Bedacht und großer Sorgfalt üppig mit Früchten und Pilzen dekoriert wird. </p>

<h2>Sternzeichen - Die kluge Eule</h2>

<img align="right" vspace="0" hspace="5" src="<?php echo $url; ?>/illarion/calendar/images/image_8.png" alt="Die kluge Eule"/>
...
<?php navBarBottom( "de_bck_12.php", "de_bck_14.php" ); ?>
