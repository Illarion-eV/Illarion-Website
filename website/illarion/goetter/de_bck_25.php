<?php
   ...
   create_header( "Illarion - Hintergrund - Client",
                  "Ronagan - Gott der Diebe und der Schatten ",
                  "Hintergrund, G&ouml;tter, Geschichte" );
   include_header();
?>

<?php navBarTop( "de_bck_24.php","de_bck_10.php","de_bck_26.php" );?>
...
<h2>Anhänger</h2>
<p>Der Dieb in der Nacht, der schattenumwogene Assassine mit blanker Klinge und die mysteriöse Frau folgen vermutlich alle Ronagan. Ronagan wird jedoch nicht nur von jenen angebetet, die von den meisten als Kriminelle angesehen würden. Diejenigen, die auf den Straßen geboren sind oder sich anderweitig in den härteren Schichten des Lebens wiederfinden, beten oft zu Ronagan, um Rat und Schutz zu finden. Die Armen beten darum, eine weitere Nacht zu überleben, ein wenig Brot zu bekommen, oder darum, dass ihnen irgendeine Art von Barmherzigkeit widerfährt. Ronagan und seine Art leben nach ihrem eigenen Kodex und viele seiner Anhänger sehen sich untereinander als Waffenbrüder an. Sie glauben, dass er sie schützt, ihnen den Weg zu ihrem nächsten Opfer zeigen wird und ihnen hilft, von den Reichen zu stehlen und der Obrigkeit auszuweichen. Es ist auch nicht ungewöhnlich, dass Händler Münzen an seinem Altar opfern, in der Hoffnung auf Schutz vor den Dieben, die Ronagan verehren. Dieses Geld wird von Ronagans Anhängern, die sich um den Altar kümmern, oft als Schutzgeld eingesammelt und dies wird dann an andere weitergeleitet, sodass diese Ausschau nach dem Händler halten.</p>

<p>Ronagan ist einer der Schutzgötter Galmairs, wo er sowohl als Wächter des Stadtvermögens und Handels angesehen wird, als auch als Vermittler vieler geheimer Geschäfte. Ein versunkener Tempel, der Ronagan geweiht und nur per Boot zu erreichen ist, kann im düsteren Untergrund von Galmair gefunden werden. Andere Anhänger wurden beobachtet, wie sie irgendwo zwischen dem Morgentausumpf und dem Todesgestank verschwanden und es wird spekuliert, dass irgendwo in der dortigen Umgebung ein verborgener Tempel liegt. Wenn ein Anhänger Ronagans stirbt, wird er vor dessen Burg gebracht und muss es, durch welche Mittel auch immer schaffen, in diese einzudringen und in die große Halle, dem Unterschlupf der Diebe einzudringen, von wo aus er dann das Paradies betreten darf. Wenn sie auf ihrem Weg dorthin erwischt werden, wird ihnen eine weiter Chance gewährt und viele mögen mehrere Anläufe benötigen. Wenn sich jemand als besonders unfähig erweist, schickt Ronagan ihn zurück unter die Lebenden, wo er damit beauftragt wird, Straßenkinder im Stehlen zu unterweisen, oder irgendeinen Gegenstand von Wert zu erbeuten.</p>

<h2>Ronas - Monat der Freigiebigkeit</h2>
...
<h2>Sternzeichen - Der schlaue Fuchs</h2>

<img align="right" vspace="0" hspace="5" src="<?php echo $url; ?>/illarion/calendar/images/image_6.png" alt="Der schlaue Fuchs"/>
...
<?php navBarBottom( "de_bck_24.php", "de_bck_26.php" ); ?>
