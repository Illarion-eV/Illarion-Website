...
<?php endif; ?>
    ...
    <p><a href="<?php echo Page::getSecureURL(); ?>/restart_rs/us_restart_rs.php">Refresh page</a></p>
...
<?php else: ?>
    ...
    <form action="<?php echo Page::getSecureURL(); ?>/restart_rs/us_restart_rs.php" method="post">
