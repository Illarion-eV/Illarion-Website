...
des Spielserver das dieser sicher nicht mehr läuft.</p>
...
<form action="<?php echo Page::getSecureURL(); ?>/restart/de_restart_rs.php" method="post">
    <input type="submit" name="submit" value="Spielserver starten"<?php echo ($running_server ? ' disabled="disabled" class="disabled"' : ''); ?> />
...
<p>In diesem Abschnitt kann der Spielserver heruntergefahren werden. Dabei werden alle Spieler und die Karte gespeichert und der
...
<form action="<?php echo Page::getSecureURL(); ?>/restart/de_restart_rs.php" method="post">
    <input type="submit" name="submit" value="Spielserver herunterfahren"<?php echo ($running_server ? '' : ' disabled="disabled" class="disabled"'); ?> />
...
<p>In diesem Abschnitt kann der Spielserver abgeschalten werden. Das hat zur Folge das der Spielserver beendet wird ohne das Spieler und
