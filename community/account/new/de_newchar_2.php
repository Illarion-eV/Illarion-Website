...
<div>
	...
	<form action="<?php echo Page::getURL(); ?>/community/account/new/de_newchar.php?charid=<?php echo $charid,($_GET['server'] == '1' ? '&amp;server=1' : ''); ?>" method="post" name="create_char" id="create_char">
		<div>
			...
			<img src="<?php echo $url; ?>/shared/pics/chars/hum/hum_m_stand_w.png" style="position:relative;left:130px; top:70px; width:28px; height:75px;" />
			<img src="<?php echo $url; ?>/shared/pics/chars/hum/hum_m_stand_n.png" style="position:relative;left:170px; top:50px; width:28px; height:75px;" />
			</div>
