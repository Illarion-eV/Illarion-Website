<?php
    ...
    Page::setTitle( 'Illarion - Kalender' );
    Page::setDescription( 'Ein grafischer Kalender des aktuellen Jahres' );
    Page::setKeywords( array( 'Kalender', 'Datum', 'Monath','Tierkreiszeichen' ) );
    //Page::setXHTML();
    Page::Init();
...
{ ?>
	...
	<table>
	    ...
	    <a href='signs/de_sign_<?php echo $this_month; ?>.php' class='lightwindow' params='lightwindow_height=450,lightwindow_width=400'>
	        <img src='images/Ximage_<?php echo $this_month; ?>.png' alt='Grafik'>
            </a>
	    </td>
