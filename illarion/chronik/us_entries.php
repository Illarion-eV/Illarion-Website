<?php
	...
	$query = 'SELECT chronicle.id, chronicle.note_en AS note, chronicle.note_de AS translation, chronicle.date, accountss.account.acc_name, accounts.account.acc_login'
